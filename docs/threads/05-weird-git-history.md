...
<summary>Have you ever seen a Git history like the one in the image above—where a commit appears to come from "nowhere" and is then attached to an otherwise complete and linear history?</summary>
